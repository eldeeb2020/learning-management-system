    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{route('update.course')}}" method="post" class="row g-3"
                ...
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">Certificates Available</label>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="label" class="form-select mb-3" aria-label="Default select example">
                        ...
                        <option value="Biggener" {{$course-> label == 'Biggener'? 'selected' : ''}}> Biggener </option>
                ...
                <div class="form-group col-md-12">
                    <label for="input1" class="form-label">Course Prerequisities</label>
                    <textarea name="prerequisities" class="form-control" id="input11" placeholder="Prerequisities"
                        rows="3"> {{$course->prerequisities}}</textarea>
                </div>
        ...
        <div class="card-body">
            <form action="{{route('update.course.video')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <video width="300" height="130" controls src="{{asset($course->video)}}"
