...
@if ($status === '1')
	<h4> Istructor Account Is <span class = "text-success"> Active </span> </h4>

@else

<h4> Istructor Account Is <span class = "text-danger"> InActive </span> </h4>

<p class = "text-danger"> <b> Please wait the admin will check and approve your account </p> </p>
